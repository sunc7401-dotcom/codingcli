...
from suncli_py.context.profile import ContextProfile
from suncli_py.lsp.manager import LspManager
from suncli_py.policy.audit_log import AuditLog
from suncli_py.policy.path_guard import PathGuard
from suncli_py.snapshot.service import SnapshotService
from suncli_py.tool.output import ToolExecutionResult, ToolOutput
...
class ToolRegistry:
    ...
    async def _execute_single(self, tool_call) -> ToolOutput:
        ...
        try:
            ...
            if should_audit:
                from suncli_py.policy.audit_log import AuditEntry
    ...
    async def _grep_code(self, params: dict) -> str:
        from suncli_py.tool.search_engine import RipgrepCodeSearchEngine
