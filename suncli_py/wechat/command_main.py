...
async def _wechat_setup() -> None:
    ...
    from suncli_py.wechat.account_store import WechatAccountStore
    from suncli_py.wechat.client import IlinkClient
    from suncli_py.wechat.qr_login import WechatQrLogin
...
async def _wechat_start() -> None:
    ...
    from suncli_py.wechat.account_store import WechatAccountStore
    from suncli_py.wechat.client import IlinkClient
    from suncli_py.wechat.message_loop import WechatMessageLoop
