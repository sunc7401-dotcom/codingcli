...
from suncli_py import __version__
from suncli_py.cli.parser import CommandType, parse
from suncli_py.config.config import PaiCliConfig
from suncli_py.llm.factory import create_client, create_client_from_config
from suncli_py.render.factory import RendererFactory
...
def _handle_command(command, state: dict[str, Any]) -> bool:
    ...
    # ── 模型/模式 ──
        ...
        from suncli_py.agent.plan_execute import PlanExecuteAgent
        if agent:
    ...
    # ── 上下文/策略/配置 ──
        ...
        from suncli_py.policy.audit_log import AuditLog
        log = AuditLog()
    ...
    # ── 微信 ──
        ...
        print("微信 iLink 通道 (需独立启动: python -m suncli_py.wechat)")
        return True
    ...
    # ── 后台任务 ──
        ...
        if tm:
            from suncli_py.runtime.task.formatter import handle
    ...
    # ── 项目记忆 ──
        ...
        from suncli_py.cli.project_memory_initializer import ProjectMemoryInitializer
...
def main() -> None:
    ...
    if args.wechat:
        ...
        print("请使用 python -m suncli_py.wechat 启动")
        return

    if args.serve or args.http:
        from suncli_py.runtime.api.server import RuntimeApiServer
    ...
    from suncli_py.hitl.terminal_handler import TerminalHitlHandler
    ...
    try:
        ...
        from suncli_py.skill.state_store import SkillStateStore
    ...
    try:
        from suncli_py.snapshot.service import SnapshotService
    ...
    task_manager = None
    try:
        from suncli_py.runtime.task.manager import DurableTaskManager
    ...
    from suncli_py.prompt.project_memory_loader import ProjectMemoryLoader
