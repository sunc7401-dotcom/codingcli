...
from paicli_py.web.search_provider import SearchProvider
...
class SearchProviderFactory:
    ...
    def create() -> SearchProvider | None:
        ...
        if glm_key:
            from paicli_py.web.providers.zhipu import ZhipuSearchProvider
        ...
        if serpapi_key:
            from paicli_py.web.providers.serpapi import SerpApiSearchProvider
            return SerpApiSearchProvider(serpapi_key)

        # 3. SearXNG
        searxng_url = _read_config("SEARXNG_URL")
        if searxng_url:
            from paicli_py.web.providers.searxng import SearxngSearchProvider
